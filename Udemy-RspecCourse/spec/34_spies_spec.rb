# spies and doubles are basically the same
# the only real difference is when you call methods
# doubles call them AFTER the expects
# spies call them BEFORE the expects
# NOTICE: the future vs past tense of the receive methods
