# allow method allows to pair a mock method with a specific return value
# we can also use it to make fake implementations of methods on
# real ruby objects, it is not strictly limited to rspec doubles
